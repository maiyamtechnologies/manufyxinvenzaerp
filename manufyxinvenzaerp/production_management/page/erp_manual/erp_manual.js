...
const ERP_MANUAL_SALES_ORDER_CHILDREN = [
	...
	},
	{
		...
		fields: [
			...
			{ name: "Material Spec", note: "Optional column, beside Grade. When filled it must already exist in the <b>Material Spec</b> master, checked by name exactly as typed. Older sheets without the column still load: the row then takes the Item's own spec." },
