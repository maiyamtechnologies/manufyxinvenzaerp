...
FIELDS = [
    ...
    ("Sales Order DUNO Item", "total_quantity", "Total Quantity", "Float",
     {"read_only_depends_on": "eval:doc.drawing || doc.docstatus===1"}),
    ("Sales Order Item", "custom_sec_qty", "Qty (Nos)", "Float", {"in_list_view": 1, "read_only": 0}),
    ...
    ("BOM", "custom_sec_qty", "Qty (Nos)", "Float", {"read_only": 1}),
    ...
    ("Production Plan Item", "custom_sec_qty", "Qty (Nos)", "Float", {"in_list_view": 1, "read_only": 0}),
    ...
    ("Subcontracting Order Item", "custom_sec_qty", "Qty (Nos)", "Float", {"read_only": 1}),
    ...
    ("Stock Entry Detail", "custom_sec_qty", "Sec Qty (Nos)", "Float", {"in_list_view": 1}),
    ...
    ("Delivery Note Item", "custom_sec_qty", "Qty (Nos)", "Float", {"in_list_view": 1, "read_only": 0}),
    ...
    ("Sales Invoice Item", "custom_sec_qty", "Qty (Nos)", "Float", {"in_list_view": 1, "read_only": 0}),
